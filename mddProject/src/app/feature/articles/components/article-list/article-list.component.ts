...
export class ArticleListComponent implements OnInit {
  ...
  sortArticles(): void {
    this.sortedArticles = [...this.articles].sort((a, b) => {
      // L'opérateur "...this.articles" crée une copie indépendante du tableau "articles"
      // pour éviter de modifier directement le tableau d'origine.
      // Cela permet de trier les articles sans impacter la source des données.
